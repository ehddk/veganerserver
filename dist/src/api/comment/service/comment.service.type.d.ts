...
export interface CommentService {
    ...
    createComment(comment: Omit<IComment, "id" | "user" | "createdAt" | "updatedAt">): Promise<CommentResponseDTO>;
    updateComment(id: string, currentUserId: string, commentInfo: Omit<IComment, "id" | "user_id" | "article_id" | "user" | "createdAt">): Promise<void>;
