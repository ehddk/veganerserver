...
export interface ArticleService {
    ...
    createArticle(article: Pick<IArticle, "title" | "content" | "author" | "author_id">): Promise<ArticleResponseDTO>;
    updateArticle(id: string, articleInfo: Omit<IArticle, "id" | "author_id" | "author" | "createdAt" | "viewCount">): Promise<void>;
