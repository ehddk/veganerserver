...
class CommentController {
    ...
    async getComments(req, res, next) {
        try {
            ...
            const values = await this._commentService.getComments(article_id, offset, limit);
    ...
    async createComment(req, res, next) {
        try {
            ...
            throw new http_exception_1.default(500, "생성 중 오류 발생");
        }
    }
    async updateComment(req, res, next) {
        ...
        try {
            const values = await this._commentService.updateComment(id, currentUserId, req.body);
            res.status(201).json(values);
        }
        catch (error) {
            throw new http_exception_1.default(404, "생성 중 오류 발생");
        }
    }
    async deleteComment(req, res, next) {
        ...
        try {
            ...
            throw new http_exception_1.default(404, "삭제 중 오류 발생");
        }
    }
}
